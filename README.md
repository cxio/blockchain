...
- [选举侧链（方案）](examples/选举侧链.md)



天道幽远，人心是成。实际上，世之大势皆由人心累聚而成，而你我即是那人心之一。微乎显乎，君子当自强而不息……


-----------------------

**声明：**
这是一个完整的设计，设计文档遵循 `GNU FDL` 版权，基本上来说，您可以自由地使用、分享、修改或再发布。设计方案为原创，不涉及任何专利，您可以按照本方案自己实现一个可运行的系统，我们也期待您这样做。为了彻底的去中心化，我们并不打算自己去实现它。欢迎您的参与 `^,^..`
