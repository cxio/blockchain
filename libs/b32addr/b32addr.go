...
// Package b32addr 专用于区块链地址的base32编码。
// 引用标准库encoding/base32源码，定制字符集，也删除了Padding相关的代码。
package b32addr
...
const EncodeAddr = "ABCDEFGKLNPQRSTVaeghijmoqrtuwxyz"
...
// 纯字母编码。
var NiceEncoding = NewEncoding(EncodeAddr)
